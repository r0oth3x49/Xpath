	...
	def Banner(self):
		...
		try:
			...
			try:
				...
				print '\n' + compat_color.fw + compat_color.sb + "["+compat_strftime("%H:%M:%S")+"] [INFO] target is not vulnerable to error-based (DOUBLE/BIGINT) injection try other techniques.."
